...
namespace ClamAgent
{
    ...
    public class ClamAVNet
    {
        ...
        public ClamAVNet(Settings settings)
        {
            // ez a temp könyvtár lehet, hogy nem azonos a workingdirectoryval
            ClamAVNet.cl_settempdir(settings.WorkingDirectory, 0);
            this._engine_ptr = new IntPtr();
            this._signo = new uint();
            this._db = settings.ClamAVDBPath;
            this._db_loaded = false;
