...
namespace ClamAgent
{
    ...
    {
        public ClamWin() {}
        public ClamWin(ClamWinConfig config)
        {
            this._clamScanPath = config.ClamScanPath;
            this._quarantineFolder = config.QuarantineFolder;
            this._clamWindDBPath = config.ClamWindDBPath;
    ...
    public class ClamWinConfig
    {
        public ClamWinConfig()
        {
            this.ClamScanPath = ConfigurationManager.AppSettings["ClamScanPath"] == "" ? this.ClamScanPath : ConfigurationManager.AppSettings["ClamScanPath"];
            this.QuarantineFolder = ConfigurationManager.AppSettings["QuarantineFolder"] == "" ? this.ClamScanPath : ConfigurationManager.AppSettings["QuarantineFolder"];
            this.ClamWindDBPath = ConfigurationManager.AppSettings["ClamWindDBPath"] == "" ? this.ClamScanPath : ConfigurationManager.AppSettings["ClamWindDBPath"];
        }
        public string ClamScanPath = @"c:\program files\ClamWin\bin\clamscan.exe";
        public string QuarantineFolder = @"C:\quarantine";
        public string ClamWindDBPath = @"C:\Documents and Settings\All Users\.clamwin\db";
    }
}
